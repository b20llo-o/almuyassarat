    ...
    return (
      <div className="page-container">
        <div className="text-center py-12">
          <h2 className="text-2xl text-primary-800 mb-4">لم يتم العثور على الخاطرة</h2>
          <button
    ...
    <div className="page-container">
      ...
      <div className="card">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-6">
          <h1 className="text-2xl sm:text-3xl font-aref font-bold text-primary-800">{thought.title}</h1>
          <span className="text-primary-500">{thought.date}</span>
        </div>
